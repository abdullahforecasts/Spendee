...
import 'pages/notifications_page.dart';
import 'pages/add_friend_page.dart';
import 'pages/select_friends_page.dart';
import 'pages/create_room_page.dart';
import 'pages/select_rooms_page.dart';
import 'pages/add_payment_account_page.dart';
import 'pages/specific_payment_account_page.dart';
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: {
        ...
        // New pages (optional - can also use MaterialPageRoute)
        '/notifications': (context) => const NotificationsPage(),
        '/add-friend': (context) => const AddFriendPage(),
      },
    );
  }
}